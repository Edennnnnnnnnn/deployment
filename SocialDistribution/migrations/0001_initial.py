...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='ProjPost',
            fields=[
                ('remote_post_id', models.CharField(help_text='remote_post_id', max_length=255, primary_key=True, serialize=False, unique=True)),
                ...
                ('proj_author', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='proj_posts', to='SocialDistribution.projuser')),
            ],
        ),
        migrations.CreateModel(
            name='User',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('date_liked', models.DateTimeField(auto_now_add=True)),
                ('proj_post', models.ForeignKey(default=99999, on_delete=django.db.models.deletion.CASCADE, related_name='remote_likes', to='SocialDistribution.projpost')),
                ('liker', models.ForeignKey(default=0, on_delete=django.db.models.deletion.CASCADE, related_name='remote_likers', to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'ordering': ['-date_liked'],
